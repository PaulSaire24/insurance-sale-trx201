...
public class ICR2BeanTest {
    ...
    public void mapInFullTest() throws IOException {
        ...
        assertEquals(input.getTotalAmount().getAmount().toString(), result.getPRITOT());
        assertEquals(input.getTotalAmount().getCurrency(), result.getDIVPRI());
        assertEquals(input.getInsuredAmount().getAmount().toString(), result.getSUMASE());
        ...
        assertEquals(input.getInstallmentPlan().getTotalNumberInstallments().toString(), result.getNUMCUO());
        assertEquals("MONTHLY", result.getTFOPAG());
        assertEquals(input.getInstallmentPlan().getPaymentAmount().getAmount().toString(), result.getMTOCUO());
