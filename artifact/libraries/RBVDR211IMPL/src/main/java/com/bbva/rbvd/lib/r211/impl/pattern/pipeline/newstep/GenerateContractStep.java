...
public class GenerateContractStep implements Step {
    private static final Logger LOGGER = LoggerFactory.getLogger(GenerateContractStep.class);
    ...
    public GenerateContractStep(DependencyBuilder dependencyBuilder) {
