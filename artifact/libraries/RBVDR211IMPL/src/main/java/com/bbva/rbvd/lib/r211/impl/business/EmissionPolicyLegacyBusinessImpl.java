...
public class EmissionPolicyLegacyBusinessImpl extends AbstractLibrary {
    private static final Logger LOGGER = LoggerFactory.getLogger(EmissionPolicyLegacyBusinessImpl.class);
    ...
    public EmissionPolicyLegacyBusinessImpl(ApplicationConfigurationService applicationConfigurationService,
                                            RBVDR201 rbvdR201,
                                            PISDR012 pisdR012,
                                            KSMKR002 ksmkR002,
                                            PISDR401 pisdR401,
                                            PISDR350 pisdR350,
                                            MapperHelper mapperHelper,PISDR601 pisdR601) {
    ...
    public PolicyDTO executeEmissionPrePolicyNotLifeLegacy(PolicyDTO requestBody) {
