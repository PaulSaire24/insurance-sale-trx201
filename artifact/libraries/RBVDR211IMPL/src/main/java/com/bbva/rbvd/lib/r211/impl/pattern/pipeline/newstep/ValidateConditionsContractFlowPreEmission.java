...
import com.bbva.rbvd.lib.r211.impl.pattern.pipeline.steps.GenerateFormalizationOracleFlowPreEmission;
...
public class ValidateConditionsContractFlowPreEmission implements Step {
    private static final Logger LOGGER = LoggerFactory.getLogger(ValidateConditionsContractFlowPreEmission.class);
