...
public class PipInsuranceBankFlowPreEmission implements PipelineInsuranceContractFactory {

    private final DependencyBuilder dependencyBuilder;



    public PipInsuranceBankFlowPreEmission(IInsuranceContractDAO insuranceContractDAO,
